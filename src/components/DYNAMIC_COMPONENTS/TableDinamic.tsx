...
// // Tipos para parámetros de consulta Nest.js
...
//     // Ejemplo de datos que vendrían de tu API de Nest.js
...
//         // Aquí harías la llamada a tu API con el nuevo número de página
//     };

//     const handleSearch = (searchText: string) => {
//         console.log('Buscar:', searchText);
//         // Aquí harías la llamada a tu API con el término de búsqueda
//     };
