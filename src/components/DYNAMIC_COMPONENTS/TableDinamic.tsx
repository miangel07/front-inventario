...
import { PaginationGet } from "@/types/configAxios/axiosConfigType";
                ...
                <Card className="border-none shadow-sm">
                    <CardBody className="px-6 py-4">
                        <Pagination
                            ...
                            personaPerPage={pagination.per_page}
                        />
                    </CardBody>
                </Card>
            )}
...
export const Pagination = ({
    ...
    const startItem = ((currentPage - 1) * personaPerPage) + 1;
    const endItem = Math.min(currentPage * personaPerPage, total);
