...
import useListCategoriesHook from '@/hooks/categoriesHooks/useListCategoriesHook'
import LayoutDefault from '@/layouts/Layoutdefault'
import { columnsCategories } from '@/utils/categoriesUtils/listCategoriesUtils'
    ...
    <LayoutDefault>
              <div className="container mx-auto px-4 py-8">
                <div className="flex justify-between items-center mb-6">
                  <h1 className="text-2xl  text-primarys-500 font-roboto">Gestión de Categorias</h1>
                  
                  <ModalDinamic
                    titleModal='Registro Categoria'
                    titleButon='Nueva Categoria'
                    sizeModal='5xl'
                    backdrop='blur'
                    ...
                    children={(onclose) => <RegisterCategoriesComponent onClose={onclose} />}
                  />
                </div>
